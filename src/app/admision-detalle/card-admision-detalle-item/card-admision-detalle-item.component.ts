...
@Component({
  selector: 'app-card-admision-detalle-item',
  templateUrl: './card-admision-detalle-item.component.html',
  styleUrls: ['./card-admision-detalle-item.component.css']
})
export class CardAdmisionDetalleItemComponent implements OnInit, OnChanges {
